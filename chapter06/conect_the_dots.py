...
IMG_NAME = 'ex6p4.jpg'
NEW_IMG_NAME = 'ex6p4_dots_connected.jpg'
...
base_img = Image.open(IMG_NAME)
print(f'Format: {base_img.format}, size: {base_img.size}, mode: {base_img.mode}')

draw = ImageDraw.Draw(base_img, 'RGBA')
draw.polygon(first, fill=(211, 84, 0, 160), outline='#000000')
draw.polygon(second, fill=(241, 196, 15, 192), outline='#CA6F1E')

font = ImageFont.truetype("arial.ttf", 36)
draw.text((225, 170), "next.py", fill='#3366CC', font=font, stroke_width=2, stroke_fill='#003399')

# last_dot, next_dot = None, None
# for dot_list in (first, second):
#     line_color = '#330033' if dot_list == first else '#003366'
#     for i in range(0, len(dot_list), 2):
#         last_dot, next_dot = next_dot, (first[i], first[i + 1])
#         if last_dot and next_dot:
#             draw.line(last_dot + next_dot, width=3, fill=line_color)

base_img.save(NEW_IMG_NAME, "JPEG")
base_img.show()
